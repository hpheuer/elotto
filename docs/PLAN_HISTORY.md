...
⚠ **Section numbers are deliberately unchanged.** Source comments cite `§1.5`, `§1.10`, `§1.12`, `§1.13`, … by number. Those citations resolve to the git copy above, not to a live contract.
