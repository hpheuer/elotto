...
Status, hardware SHAs and what is / is not yet exercised: **[docs/STATUS.md](docs/STATUS.md)**.
Session archive index: **[docs/data/README.md](docs/data/README.md)**.
⚠ Both are history, not rules. Everything above this line is the rule set and stays here.
