...
"top=s.slice(0,10);"
"endTxt=(SORTD<0)?'highest':'lowest';"
"}else{top=(d.top||[]).slice(0,10);endTxt='highest';}"
...
"<table><thead><tr>"
"<th class='l' title=\"board and address. Each row is that node answering for itself\">Node</th>"
